...
export default function Page() {
  ...
  const ChatView = (
    <main className="min-h-screen flex flex-col bg-[#FFF8F1] text-[#11122D]">
      ...
      {/* Footer height = 96px (h-24). Tweak once and reuse */}
      

        {/* Chat area fills viewport minus footer and small gap */}
        <div className="min-h-[100dvh] flex flex-col bg-stone-50 [--footer:96px] [--gap:8px] overflow-hidden">
          <div className="w-full max-w-5xl h-[calc(100dvh-var(--footer)-var(--gap))]">
            <Card className="h-full rounded-2xl shadow-sm border bg-white/90 backdrop-blur overflow-hidden">
              <CardContent className="h-full overflow-hidden p-6 sm:p-10">
                <Chat
                  onExit={handleExit}
        ...
        {/* Fixed footer (must match --footer above) */}
        <footer className="fixed inset-x-0 bottom-0 z-40 h-1rem border-t border-black/5 bg-[#FFF8F1]/90 backdrop-blur">
